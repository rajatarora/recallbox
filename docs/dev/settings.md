...
- **`recallbox/conf/settings.py`**: Main Settings class
- **`recallbox/conf/db.py`**: Database settings
- **`recallbox/settings.py`**: Global settings instance
...
```python
from recallbox.conf import settings
...
from recallbox.conf.settings import Settings
...
```python
from recallbox.conf.cache import CacheSettings
