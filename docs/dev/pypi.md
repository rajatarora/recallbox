...
write_to = "recallbox/_version.py"
```
...
[project]
name = "recallbox"
description = "A command-line second brain that remembers your memories"
authors = [{"name" = "Rajat Arora"}]
...
ls dist/
# recallbox-1.2.3.tar.gz
# recallbox-1.2.3-py3-none-any.whl
```
...
# Install from wheel
pip install dist/recallbox-*.whl

# Verify installation
python -c "import recallbox; print(recallbox.__version__)"
...
1. Go to your project page: `https://pypi.org/project/recallbox/`
...
```bash
# View on PyPI
open https://pypi.org/project/recallbox/

# Install from PyPI
pip install recallbox
